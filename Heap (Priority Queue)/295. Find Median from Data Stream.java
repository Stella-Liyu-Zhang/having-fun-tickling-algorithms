 ...
 */
 ...
 class MedianFinder {
    private PriorityQueue<Integer> large; //save large values
    private PriorityQueue<Integer> small; //save small values
    ...
    //make sure that small store the extra one in odd cases.
    public void addNum(int num) {
        if(even){
            large.offer(num);
